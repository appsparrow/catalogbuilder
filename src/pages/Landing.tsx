          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Professional catalog management for modern businesses.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><a href="mailto:support@cuzata.com" className="hover:text-white transition-colors">Contact Us</a></li>
                <li><span className="text-gray-500">support@cuzata.com</span></li>
              </ul>
            </div>
          </div>
